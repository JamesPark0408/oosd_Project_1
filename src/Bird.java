...
// Use the numbering of level to access different folders and initialize the photos accordingly
//
/**
...
public class Bird {
    ...
    private Image FLAPPYUP = new Image("res/birdWingUp.png");
    private Image FLAPPYDOWN = new Image("res/birdWingDown.png");
